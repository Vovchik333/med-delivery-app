...
describe("/api/v2/cart-items", () => {
    ...
    beforeEach(async () => {
        const { _id: medicineId } = await medicineService.createMedicine(MEDICINE_DATA, jwtManager.verifyJwt(ADMIN_ACCESS_TOKEN));
    ...
    describe("GET /api/v2/cart-items", () => {
        it("should return an array of cart items", async () => {
            await cartItemService.createCartItem(CART_ITEM_DATA);
    ...
    describe("GET /api/v2/cart-items/:id", () => {
        ...
        it("should be returned message that the object was not found", async () => {
            const res = await request(app.getInstance())
                .get(`/api/v2/cart-items/00004d6a0000b9219d880000`);
    ...
    describe("POST /api/v2/cart-items", () => {
        it("should return created cartItem", async () => {
            const res = await request(app.getInstance())
        ...
        it("should return the same object, but with an increased number by 1", async () => {
            ...
            const cartRes = await request(app.getInstance())
                .get(`/api/v2/carts/${shoppingCartId}`);
    ...
    describe("PUT /api/v2/cart-items", () => {
        ...
        it("should be returned message that the object was not found", async () => {
            const res = await request(app.getInstance())
                .put(`/api/v2/cart-items/00004d6a0000b9219d880000`);
    ...
    describe("DELETE /api/v2/cart-items/:id", () => {
        ...
        it("should be returned message that the object was not found", async () => {
            const res = await request(app.getInstance())
                .delete(`/api/v2/cart-items/00004d6a0000b9219d880000`);
